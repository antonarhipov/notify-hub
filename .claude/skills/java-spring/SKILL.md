...
Structure code **around business capabilities**, not technical layers. See [references/ddd-patterns.md](references/ddd-patterns.md) for patterns and examples.
...
See [references/data-access.md](references/data-access.md) for entity mapping and repository patterns.
See [references/transactions.md](references/transactions.md) for transaction management rules.
...
See [references/testing.md](references/testing.md) for setup and patterns.
...
See [references/mapping.md](references/mapping.md) for patterns and examples.
...
- [DDD Patterns](references/ddd-patterns.md) — Aggregates, entities, value objects, domain events
- [Data Access](references/data-access.md) — Spring Data JPA entities, repositories, fetching strategies
- [Transactions](references/transactions.md) — JPA transaction management, propagation, locking
- [Testing](references/testing.md) — Testcontainers setup and integration test patterns
- [Mapping](references/mapping.md) — MapStruct patterns, layer boundaries, DTO design
